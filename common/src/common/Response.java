...
public enum Response {
	FOUND_QUESTIONS("FOUND_QUESTIONS", 0),
	DIDNT_FOUND_QUESTIONS("DIDNT_FOUND_QUESTIONS", 1),
	EDIT_QUESTIONS_SUCCESS("EDIT_QUESTIONS_SUCCESS", 2),
	EDIT_QUESTIONS_FAILD("EDIT_QUESTIONS_FAILD", 3),
	UPDATE_CONNECTION_SUCCESS("UPDATE_CONNECTION_SUCCESS", 4),
	UPDATE_CONNECTION_FAILD("UPDATE_CONNECTION_FAILD", 5),
	LOGIN_SUCCESS("LOGIN_SUCCESS",6), LOGIN_FAILURE("LOGIN_FAILURE", 7), FOUND_TESTS("FOUND_TESTS",8), DIDNT_FOUND_TESTS("DIDNT_FOUND_TESTS",9);
